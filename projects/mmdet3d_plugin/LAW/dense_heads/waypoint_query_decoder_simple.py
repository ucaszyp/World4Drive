...
class SimpleWayDecoderHead(BaseModule):
    ...
    def forward(self, img_feat, img_metas, ego_info=None, is_test=False):
        ...
        # predict wp
        updated_waypoint_query_feat = self.wp_attn(init_waypoint_query_feat, final_view_feat)
        ...
        pred_img_feat = self.wm_prediction(spatial_view_feat, cur_waypoint)

        return cur_waypoint, spatial_view_feat, pred_img_feat
